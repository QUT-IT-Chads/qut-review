...
import Recent from '../types/recent/recent';
...
const recents: Array<Recent> = [
    {
        ...
        unitDescription:
            `With the explosion of information resources on the Web, 
    ...
    },
    {
        ...
        unitDescription:
            `This unit introduces you to the components inside a computer and 
